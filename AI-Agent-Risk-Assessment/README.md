...
![Baseline test showing the AI drafting a normal email](screenshots/01-baseline.jpg)
...
![AI successfully detecting and blocking the prompt injection payload](screenshots/03-defense.jpg)
...
![AI safely processing legitimate data while ignoring the attack](screenshots/04-exploit.jpg)
